class Humano(): 
    """
        ...
        nombreEntrada: Hace referencia al nombre del usario
    ...
    def ahorraDinero(self):
        preguntaIngresarMontos = "Ingrese S --> para continuar anadiendo montos y N --> para finalizar: "
        preguntaMontos = "Cuanto vas a ingresar?: "
        ingresarMontos = input(preguntaIngresarMontos)
        while(ingresarMontos != "N"):
            monto = float(input(preguntaMontos))
